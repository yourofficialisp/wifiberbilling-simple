...
<body>
    <div class="no-print" style="text-align: center; margin-bottom: 20px;">
        ...
        <a href="<?php echo htmlspecialchars($basePrintUrl); ?>" style="display: inline-block; padding: 10px 20px; cursor: pointer; text-decoration: none; color: #000; border: 1px solid #ccc; background: #f3f3f3;">Normal Mode</a>
        <a href="<?php echo htmlspecialchars($thermalUrl); ?>" style="display: inline-block; padding: 10px 20px; cursor: pointer; text-decoration: none; color: #000; border: 1px solid #ccc; background: #f3f3f3;">Thermal Mode 58mm</a>
        <button onclick="window.location.href='invoices.php'" style="padding: 10px 20px; cursor: pointer;">Back</button>
    </div>

    <div class="invoice-box">
        <div class="header">
            <h2><?php echo $appName; ?></h2>
            <p>Internet Bill Payment Receipt</p>
        </div>
        ...
        <div class="qr-wrap">
            ...
            <div class="qr-box">
                ...
                <div class="qr-caption">Scan for quick check/print</div>
            </div>
        </div>
        ...
        <div class="thermal-lines">
            ...
            <?php foreach ($invoices as $inv): ?>
                ...
                <div class="line"><span class="muted">Package</span><span><?php echo htmlspecialchars($inv['package_name']); ?></span></div>
                <div class="line"><span class="muted">Period</span><span><?php echo htmlspecialchars(formatDate($inv['due_date'], 'M Y')); ?></span></div>
                <div class="line"><span class="muted">Amount</span><strong><?php echo htmlspecialchars(formatCurrency($inv['amount'])); ?></strong></div>
                <div class="divider"></div>
            <?php endforeach; ?>
        </div>

        <div class="total">
            Total Paid: <?php echo formatCurrency($totalAmount); ?>
        </div>
        ...
        <div class="footer">
            ...
            <p>Save this receipt as valid proof of payment.</p>
        </div>
    </div>
